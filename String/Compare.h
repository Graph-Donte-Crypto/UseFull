...
namespace str {
	bool CompareWeak(const char * in1, const char * in2) {
		while (true) {
	...
	bool CompareWeakUncase(const char * in1, const char * in2) {
		while (true) {
	...
	int CompareStrong(const char * in1, const char * in2, const char * alphabet = nullptr) {
		if (alphabet == nullptr) {
			while (true) {
				if (*in1 != *in2) {
					if (*in1 > *in2) return 1;
