...
#include "../../UseFull/String/StringFormatBuilder.hpp"
...
namespace math {
	...
	struct Vector {
		...
		std::string toString(C char * format = "%07.3lf ") C {
			str::StringFormatBuilder<256 * dimension> builder;
			for (size_t i = 0; i < dimension; i++)
				builder.append(coords[i], format);
